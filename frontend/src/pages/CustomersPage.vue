  ...
  <div class="p-6">
    ...
    <el-card>
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column prop="customerCode" label="Code" min-width="80" />

        <el-table-column prop="customerName" label="Name" min-width="120" />

        <!-- <el-table-column prop="contactPerson" label="Contact" min-width="160" /> -->

        <el-table-column prop="mobile" label="Mobile" min-width="100" />
...
const rules: FormRules = {
  customerCode: [
    { required: true, message: "Please enter customer code", trigger: "blur" },
  ],
  customerName: [
...
const loadCustomers = async () => {
  loading.value = true;
  try {
    const response = await customerService.getPaged(
      currentPage.value,
      pageSize.value,
      searchTerm.value,
    );
